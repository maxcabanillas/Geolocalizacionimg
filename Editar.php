...
<body>
	...
	<div class="search" id="search">   
					<input type="hidden" value ="act" name="act" id="act"/>
                     <span class="espectaculares"><span class="label">Espectaculares: </span><select name='Espectacular' id='Espectacular' onchange="ActCampanas(this.value,0);" class="styledesp">
